...
public class ILoanRepositoryImpl implements ILoanRepository {
    ...
    public boolean applyLoan(Loan loan) throws InvalidLoanException {
        try (PreparedStatement preparedStatement = connection.prepareStatement(APPLY_LOAN_QUERY)) {
    ...
    public double calculateInterest(int loanId) throws InvalidLoanException {
        try (PreparedStatement preparedStatement = connection.prepareStatement(CALCULATE_INTEREST_QUERY)) {
...
//    }
    ...
    public void loanStatus(int loanId) throws InvalidLoanException {
        try (PreparedStatement preparedStatement = connection.prepareStatement(LOAN_STATUS_QUERY)) {
    ...
    public double calculateEMI(int loanId) throws InvalidLoanException {
        try (PreparedStatement preparedStatement = connection.prepareStatement(CALCULATE_EMI_QUERY)) {
            preparedStatement.setLong(1, loanId);
            ResultSet resultSet = preparedStatement.executeQuery();
    ...
    public int loanRepayment(int loanId, double amount) throws InvalidLoanException {
        try (PreparedStatement preparedStatement = connection.prepareStatement(LOAN_REPAYMENT_QUERY)) {
            preparedStatement.setLong(1, loanId);
    ...
    public List<Loan> getAllLoans() {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(GET_ALL_LOANS_QUERY);
             ResultSet resultSet = preparedStatement.executeQuery()) {
    ...
    public Loan getLoanById(int loanId) throws InvalidLoanException {
        try (PreparedStatement preparedStatement = connection.prepareStatement(GET_LOAN_BY_ID_QUERY)) {
            preparedStatement.setLong(1, loanId);
            ResultSet resultSet = preparedStatement.executeQuery();
