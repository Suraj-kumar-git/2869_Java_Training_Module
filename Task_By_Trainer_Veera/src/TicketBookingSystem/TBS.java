			...
			if (seatBooking <= totalSeats) {
				if (isAbove50) {
					if (remainFrom50 - seatBooking >= 0) {
						...
						if (greaterThan50 <= 25) {
							System.out.println(
									greaterThan50 + " tickets are booked with a fine of 18% extra on fare charges.");
							fare = fare + fare * 0.18;
							...
							System.out.println(
									greaterThan75 + " tickets are booked with a fine of 32% extra on fare charges.");
							fare = 264;
					...
					if (greaterThan50 > seatBooking) {
						...
						System.out
								.println(seatBooking + " tickets are booked with a fine of 18% extra on fare charges.");
						totalFare += (fare * seatBooking);
						totalSeats -= seatBooking;
						seatsBooked += seatBooking;
						remainFrom75 -= seatBooking;
						...
						remainFrom75 = 0;
						isAbove75 = false;
						if (seatsBooked + seatBooking <= 100) {
							int greaterThan75 = seatBooking - seatsBooked;
							System.out.println(
									greaterThan75 + " tickets are booked with a fine of 32% extra on fare charges.");
							fare = 264;
				...
				if (yesOrNo == 'Y' || yesOrNo == 'y') {
					if (isAbove50) {
						if (remainFrom50 - seatBooking > 0) {
							...
							if (greaterThan50 < 25) {
								...
								System.out.println(greaterThan50
										+ " tickets are booked with a fine of 18% extra on fare charges.");
								totalFare = totalFare + (fare * greaterThan50);
								seatsBooked += greaterThan50;
								totalSeats -= greaterThan50;
							} else {
								...
								seatsBooked += 25;
								int greaterThan75 = seatBooking - seatsBooked;
								System.out.println(greaterThan75
										+ " tickets are booked with a fine of 32% extra on fare charges.");
								fare = 264;
								totalFare += fare * greaterThan75;
								totalSeats -= greaterThan75;
								remainFrom75 = 0;
						...
						if (greaterThan50 > seatBooking) {
							...
							System.out.println(
									seatBooking + " tickets are booked with a fine of 18% extra on fare charges.");
							totalFare += (fare * seatBooking);
							totalSeats -= seatBooking;
							seatsBooked += seatBooking;
							...
							System.out.println(
									totalSeats + " tickets are booked with a fine of 32% extra on fare charges.");
						} else {
							if (fare == 200) {
								fare += fare * 0.18;
							}
