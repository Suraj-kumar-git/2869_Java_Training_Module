...
public class Loan {
	...
	public String toString() {
		return "Loan [loanId=" + loanId + ", customerId=" + customerId + ", principalAmount=" + principalAmount
				...
				+ ", loanStatus=" + loanStatus + ", getLoanId()=" + getLoanId() + ", getCustomerId()=" + getCustomerId()
				+ ", getPrincipalAmount()=" + getPrincipalAmount() + ", getInterestRate()=" + getInterestRate()
				+ ", getLoanTerm()=" + getLoanTerm() + ", getLoanType()=" + getLoanType() + ", getLoanStatus()="
